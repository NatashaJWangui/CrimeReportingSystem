...
<div id="left">
	...
	<ul class="menu">
	  ...
	  <?php
	   ...
	   <?php 
		  ...
		  <li class="item63"><a href="viewfir.php"><span>View crime report details </span></a></li>
	...
	<?php 
		  ...
		  <li class="item63"><a href="FIRreg1.php"><span>Register Your crime  </span></a></li>
		  <li class="item63"><a href="editFIRdetail.php"><span>Edit Your crime reportdetails </span></a></li>
