...
<div id="left">
	...
	<div id="container" class="wrapper-container">
       ...
       <div class="corner-bottom-right">
        <form action="chkFIRreg2.php" method="post" enctype="multipart/form-data" name="form1">
		 <div>
		   <h2><span class="componentheading"><em>Step:2. Fill the following crime report details</em></span></h2>
    ...
    <div class="footer clear">
    	<span>crime reporting of kenya© 2016 |  <a href="#">Privacy Policy</a></span>
