   ...
   <div class="header-box clear">		
    ...
    <div class="newsticker-jcarousellite">
		<ul>
            <li>
				<div class="thumbnail">
					<img src="images/murder1.jpg" width="187">
					<div class="info">
					<a href="http://www.vladstudio.com/wallpaper/?knight_lady">Murder increase in mwiki</a></div>
				</div>
            ...
            <li>
				<div class="thumbnail">
					<img src="images/crime reduction.png" width="188" height="83">
					<div class="info">
					<a href="http://www.vladstudio.com/wallpaper/?family_of_colors">crime rate reduction in central areas of Kenya</a></div>
				</div>
				
				<div class="clear"></div>
			</li>
            <li>
				<div class="thumbnail"><img src="images/recruitment.jpg" alt="recruitment" width="187" height="139" longdesc="http://recruitment" />
				  <div class="info">
					<a href="http://www.vladstudio.com/wallpaper/?teddybear_mac">Police recruitment underway in major counties in Kenya </a></div>
				</div>
				
				<div class="clear"></div>
			</li>
			<li>
				<div class="thumbnail"><img src="images/honour.jpg" alt="hounour" width="187" height="104" longdesc="http://honour" />
				  <div class="info">
					<a href="http://www.vladstudio.com/wallpaper/?rainbow_butterfly">Reduction in bribing incident among police officers noted </a></div>
				</div>
				
				<div class="clear"></div>
			</li>
			<li>
				<div class="thumbnail"><img src="images/force.jpg" alt="force" width="189" height="114" longdesc="http://force" />
				  <div class="info">
					<a href="http://www.vladstudio.com/wallpaper/?space_travel">commendable police force in in sports </a></div>
				</div>
	...
	<tbody>
	<tr>
	  <td width="120" height="98" valign="top" bordercolor="#000000"><img src="images/police chief.jpg" alt="police chief" width="135" height="144" longdesc="http://police chief" />&nbsp;</td>
	  <td width="332" colspan="2" valign="top"><h3><a href="http://news.bbc.co.uk/2/hi/south_asia/8638958.stm" onmousedown="return   clk(this.href,'news_result','','res','1','','0CDAQqQIwAA')">Kenya police chief quizzed over corruption</a></h3>
	    Investigators have questioned the chief of the Kenya police over allegations of corruption l. 
	    <div> </div></td>
	</tr>
	<tr>
	  <td>&nbsp;</td>
	...
	<tr><td class="article_column" valign="top" width="100%"><div class="article-indent">
      <div class="clear">
        <table class="contentpaneopen">
          <tbody>
            <tr>
              <td width="120" height="98" valign="top" bordercolor="#000000"><img src="images/police chief1.jpg" alt="police chief1" width="135" height="128" longdesc="http://police chief1" />&nbsp;</td>
              <td width="332" colspan="2" valign="top"><h3><a href="http://news.bbc.co.uk/2/hi/south_asia/8638958.stm" onmousedown="return   clk(this.href,'news_result','','res','1','','0CDAQqQIwAA')">Inspector of police <em></em> getting SIT summons</a></h3>
                Investigators have summoned the inspector of police to EACC for questioning over alleged corruption in the police force
                <div> </div></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
	    ...
	    <div class="article-indent">
          <div class="clear">
            <table class="contentpaneopen">
              <tbody>
                <tr>
                  <td width="120" height="98" valign="top" bordercolor="#000000"><img src="images/police chief2.jpg" alt="police chief2" width="133" height="122" longdesc="http://police chief2" />&nbsp;</td>
                  <td width="332" colspan="2" valign="top"><h3><a href="http://news.bbc.co.uk/2/hi/south_asia/8638958.stm" onmousedown="return   clk(this.href,'news_result','','res','1','','0CDAQqQIwAA')">Police airwing  Chief minister<em>i</em> getting SIT summon</a></h3>
                   Police airwing boss probed over use of offcial police aircraft for personal reasons  <div>					</div></td>
                </tr>
    ...
    <div class="footer clear">
    	<span>Crime Reporting of Kenyat &copy; 2016  |  <a href="#">Privacy Policy</a></span>Crime Reporting is for registering crimes any time and any where in Kenya released under HCL Info System.&nbsp;&nbsp;<!--{%FOOTER_LINK} -->
    </div>
</div>
