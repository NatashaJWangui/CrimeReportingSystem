	...
	<div id="container" class="wrapper-container">
       ...
       <div class="corner-bottom-right">
        <form action="chkcrimealert.php" method="post"  enctype="multipart/form-data" name="">
		 <div>
		   <h2><span class="componentheading"><em>Create An Email Alert !!!!!:</em></span></h2>
		 </div>             
           <p>&nbsp;</p>
           <table width="565" border="0">
             <tr bgcolor="#993366">
               <td width="170" align="right" valign="middle" bgcolor="#FFFFFF"><span class="style19" style="color: #000000">Alert City Name:</span>
...
<option>-----select-----</option>
  ...
  <script type="text/javascript">
		  ...
		  <div>
		    <h2>&nbsp;&nbsp;<span class="style16"> Step:2.Choose Your Alert Preference: </span></h2>
		  </div>             
           <table width="565" align="center" cellpadding="10" cellspacing="20">
			 <tr bgcolor="#993366">
               <td height="39" valign="middle" bgcolor="#FFFFFF"><span class="style15">
                 <script type="text/javascript">
