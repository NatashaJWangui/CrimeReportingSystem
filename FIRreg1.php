...
<div id="left">
	...
	<div id="container" class="wrapper-container">
       ...
       <div class="corner-bottom-right">
        <form action="chkFIRreg1.php" method="post" enctype="multipart/form-data" name="form1">
		 <div>
		   <h2><span class="componentheading"><em>Step:1. Fill the following crime report details:</em></span>
		   </span></h2>
		 </div>             
           <p>&nbsp;</p>
    ...
    <div class="footer clear">
    	<span>Crime reporting of kenya © 2016  |  <a href="#">Privacy Policy</a></span>. &nbsp;&nbsp;&nbsp;<!--{%FOOTER_LINK} -->
    </div>
</div>
